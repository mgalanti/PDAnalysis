...
echo Running analyzer: ./analyzeElectronEfficiency -c CFGFILE -n $eventsPerJob -s $skipEvents
./analyzeElectronEfficiency -c CFGFILE -n $eventsPerJob -s $skipEvents
...
rm -v ./analyzeElectronEfficiency

echo " "

echo Moving histogram output file: mv his__ElectronEfficiencyAnalyzer__SAMPLENAME__EVTSELECTION__0.root his/his__ElectronEfficiencyAnalyzer__SAMPLENAME__EVTSELECTION__TIMENOW__${skipEvents}__${lastEvent}.root
mkdir his
mv his__ElectronEfficiencyAnalyzer__SAMPLENAME__EVTSELECTION__0.root his/his__ElectronEfficiencyAnalyzer__SAMPLENAME__EVTSELECTION__TIMENOW__${skipEvents}__${lastEvent}.root
