...
echo Running analyzer: ./plotElectronVariables -c CFGFILE -n $eventsPerJob -s $skipEvents
./plotElectronVariables -c CFGFILE -n $eventsPerJob -s $skipEvents
...
mkdir his
mv his__ElectronVariablesPlotter__SAMPLENAME__EVTSELECTION__0.root his/his__ElectronVariablesPlotter__SAMPLENAME__EVTSELECTION__TIMENOW__${skipEvents}__${lastEvent}.root
