...
jobDir=${srcDir}/ElectronVariablesPlotter/bin/plotElectronVariables_job_${timeNow}

libFile=lib_${timeNow}.tar.gz
cfgFile=plotElectronVariables_${timeNow}.cfg
scriptFile=plotElectronVariables_${timeNow}.sh
jobConfigFile=plotElectronVariables_${timeNow}.jobconfig
...
done < plotElectronVariables.cfg
...
sed -e "s#JOBDIR#${jobDir}#g" -e "s#SCRIPTFILE#${scriptFile}#g" -e "s#EVENTSPERJOB#${eventsPerJob}#g" -e "s#LIBFILE#${libFile}#g" -e "s#EXEDIR#${exeDir}#g" -e "s#CFGFILE#${cfgFile}#g" -e "s#TREELISTFILE#${treeListFile}#g" -e "s#OUTFILES#${outFiles}#g" -e "s#NJOBS#${nJobs}#g" plotElectronVariables_template.jobconfig > ${jobDir}/${jobConfigFile}

# Create shell script executable from template inside the job directory
echo Creating file ${jobDir}/${scriptFile}
sed -e "s#LIBFILE#${libFile}#g" -e "s#CFGFILE#${cfgFile}#g" -e "s#SAMPLENAME#${sampleName}#g" -e "s#EVTSELECTION#${evtSelection}#g" -e "s#SECONDNTUPLEBASENAME#${secondNtupleBaseName}#g" -e "s#TIMENOW#${timeNow}#g" plotElectronVariables_template.sh > ${jobDir}/${scriptFile}
...
echo Copying executable ${exeDir}/plotElectronVariables to job directory
cp ${exeDir}/plotElectronVariables ${jobDir}/plotElectronVariables
