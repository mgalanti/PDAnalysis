...
echo Running analyzer: ./flavortagOSElectron -c CFGFILE -n $eventsPerJob -s $skipEvents
./flavortagOSElectron -c CFGFILE -n $eventsPerJob -s $skipEvents
...
rm -v ./flavortagOSElectron

echo " "

echo Moving histogram output file: mv his__OSElectronFlavorTagger__SAMPLENAME__EVTSELECTION__0.root his/his__OSElectronFlavorTagger__SAMPLENAME__EVTSELECTION__TIMENOW__${skipEvents}__${lastEvent}.root
mkdir his
mv his__OSElectronFlavorTagger__SAMPLENAME__EVTSELECTION__0.root his/his__OSElectronFlavorTagger__SAMPLENAME__EVTSELECTION__TIMENOW__${skipEvents}__${lastEvent}.root
